...
@Component({
    ...
    <main class="listing-page">
      <section class="page-hero">
        <div>
          <p>Buy Condo</p>
          <h1>ซื้อคอนโด</h1>
          <span>ค้นหาประกาศขายคอนโดตามทำเล ราคา และรูปแบบห้องที่ต้องการ</span>
        </div>
      </section>
      ...
      <section class="content-shell">
        <aside class="filter-card">
          ...
          <label>
            ...
            <input [(ngModel)]="location" (ngModelChange)="applyFilters()" placeholder="เช่น สุขุมวิท" />
          </label>
          <label>
            <span>ช่วงราคา</span>
        ...
        <section class="results">
          <div class="result-toolbar">
            <div>
              ...
              <span>ประกาศขายคอนโดพร้อมข้อมูลครบ</span>
            </div>
  ...
  styles: `
    ...
    .page-hero {
      background: linear-gradient(135deg, rgba(7, 59, 58, 0.96), rgba(11, 111, 111, 0.76)), url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1600&q=80') center/cover;
      color: #fff;
      padding: 72px 24px;
    }
    .page-hero > div,
    ...
    .empty-state {
      ...
      border-radius: 14px;
      box-shadow: 0 16px 36px rgba(7, 59, 58, 0.08);
    }
    .filter-card {
      align-self: start;
      display: grid;
