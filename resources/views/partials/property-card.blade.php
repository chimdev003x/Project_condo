<article class="card property-card">
    ...
    <div class="card-body">
        ...
        <div class="meta">
            <span><span class="mini-icon"><i class="fi fi-br-bed"></i></span>{{ $property->bedrooms }} ห้องนอน</span>
            <span><span class="mini-icon"><i class="fi fi-br-bath"></i></span>{{ $property->bathrooms }} ห้องน้ำ</span>
            <span><span class="mini-icon"><i class="fi fi-br-expand"></i></span>{{ number_format($property->area) }} ตร.ม.</span>
        </div>
